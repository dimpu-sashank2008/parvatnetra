...
| :---: | :---: | :---: | :---: | :---: |
| **Sheet 78M** | **Tawang Quadrangle** | Arunachal Pradesh (Tawang, Sela Pass, Lumla, NH-13) | Se La Group Higher Himalayan Crystallines, Galensiniak migmatitic gneiss, Bomdila Group, Dirang / Lumla Formation | **Main Central Thrust (MCT)** curvi-planar thrust, **Gomkangrong Fault** (1.75 km offset), Lumla antiformal tectonic window |
| **Sheet 83I** | **Lower Siang Quadrangle** | Arunachal Pradesh / Assam (Basar, Likabali, Lower Siang, Dhemaji, Subansiri) | Pari Mountain Gneiss, Siang Group (Rungong Fm), Boleng & Miri groups, Rotung agglomeratic basalts, Siwaliks | **Main Boundary Thrust (MBT)**, **Himalayan Frontal Thrust (HFT)**, **Tipi Thrust**, **Bomdila Thrust**, **Miri Thrust** |
| **Sheet 83E** | **Dafla Quadrangle** | Arunachal Pradesh / Assam (Itanagar, Papum Pare, Kimin, Ziro, Lower Subansiri) | Bomdila Group (Khetabari & Chilliepam Fms), Lichi Volcanics, Bichom/Bhareli Gondwana, Dafla/Subansiri/Kimin Siwaliks | **Main Boundary Thrust (MBT)**, **Tipi Thrust**, **Bomdila Thrust**, Ranganadi & Dikrang toe gorges |
