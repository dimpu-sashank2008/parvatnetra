...
class RealtimeCRIService:
    ...
    def evaluate_sector(self, sector_id: str) -> Dict[str, Any]:
        ...
        record: Dict[str, Any] = {
            ...
            "visibility_m": round(float(features.get("visibility_m", climate_data.get("visibility_m", 8000.0))), 1),
            "visibility_km": round(float(features.get("visibility_km", climate_data.get("visibility_km", 8.0))), 2),
            "fog_classification": str(climate_data.get("fog_classification", "CLEAR")),
            "fog_label": str(climate_data.get("fog_label", "CLEAR HORIZONTAL VISIBILITY")),
            "speed_limit": str(climate_data.get("speed_limit", "Max 50 km/h")),
            "driving_advisory": str(climate_data.get("driving_advisory", "Optimal sight distance. Normal convoy and vehicle transit permitted.")),
            "visibility_color": str(climate_data.get("visibility_color", "#10B981")),
